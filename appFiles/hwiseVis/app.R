...
# Ribbon -----------------------------------------------------------------------
  ...
  file<-tempdir()
  unzip("shapefiles/union/bgd_admbnda_adm4_bbs_20201113.zip", exdir=file)
  ...
  observeEvent({
    ...
    #   colorData <- filtered_data()[[input$circle_color]]
    #   color <- colorNumeric(pal1(length(levels(factor(text.data()[[input$circle_color]])))), domain = text.data()[[input$circle_color]])
    #   legend_vals = text.data()[[input$circle_color]]
