...
ui <- fluidPage(
  ...
  fluidRow(
    useSweetAlert(),
    column(3, div(id = "img-id", img(src = "logo_1.png"), style = {"padding-left:20px"})),
    ...
    column(3,br(),actionBttn("close","Close", style = "simple", color = "danger", icon = icon("power-off"))),
  ),
  br(),
...
# Ribbon -----------------------------------------------------------------------
    ...
    if (phase() == 1) {
      ...
      df <- df %>%
        mutate(across(c("gps-latitude","gps-longitude","sd3","sd6_","sd7","sd8","sd10","sd13","sd20","sd21","wb5","wb6",
                        ...
                        "wat19","wat20","wat21","wat22","wat23","wat24","wat25","hw",
  ...
  filtered_data <- eventReactive({
    ...
    input$source_toggle}, {
      ...
      if(is.null(input$source_toggle) & is.null(input$hw2_toggle) & is.null(input$quality_toggle)){
  ...
  observeEvent({
    ...
    if (class(raw.dataA()[[input$circle_color]])=="numeric") {
      ...
      color <- colorNumeric(rev(pal1(6)), domain = raw.dataA()[[input$circle_color]])
      legend_vals = raw.dataA()[[input$circle_color]]
      
      #circle color variable: categorical
    } else {
      # "often" scale
      ...
      leafletProxy("mymap") %>%
        ...
        addCircleMarkers(data = filtered_data(),
                         ...
                         popup = ~paste(
                           "<b>", "HWISE Score: ","</b>",hw,"<br/>",
                           "<b>","Primary source (drinking): ","</b>",wat1, "<br/>",
                           "<b>","Primary source (non-drinking): ","</b>",wat10, "<br/>",
                           "<b>","Collection Time (drinking, weekly): ","</b>",wat5a, "<br/>",
                           "<b>","Treatment (drinking): ","</b>",wat9_, "<br/>",
                           "<b>","Quality problems: ","</b>",wat8, "<br/>",
                           "<b>","Supply interruptions: ","</b>",hw2, "<br/>",
                           "<b>","No useable/drinkable water: ","</b>",hw11, "<br/>",
                           "<b>","Borrow water: ","</b>",hw13, "<br/>"
